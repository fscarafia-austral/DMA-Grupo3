...
if __name__ == "__main__":
    model, unique_names = train_and_evaluate()
    
    # Predicción con ensemble
    image_path = "/home/gugui/Documentos/Austral/Austral/Data mining avanzado/Trabajo_practico/DMA-Grupo3-main/test/IMG-20240406-WA0014.jpg-11-1.jpg"
    image_processed = model.preprocess_image(image_path).reshape(1, -1)
    
    # Hacer múltiples predicciones con dropout
    n_predictions = 5
    predictions = []
    for _ in range(n_predictions):
        pred = model.predict(image_processed, dropout=True)
