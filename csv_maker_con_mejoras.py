...
faces_csv_path = os.path.join(output_dir, "faces_train.csv")
names_csv_path = os.path.join(output_dir, "names_train.csv")
files_csv_path = os.path.join(output_dir, "files_train.csv")
